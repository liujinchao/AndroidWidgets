 ...
 * 取景框
 */
public class OverlayCameraView extends View {
     ...
     * 拐角线的宽度
     */
    private int cornerLineWidth = DimensionUtil.dpToPx(3);
    ...
    public OverlayCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public OverlayCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
