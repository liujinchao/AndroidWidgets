...
public class CcMaskView extends View {

    public static final int MASK_TYPE_NONE = 0;

    @IntDef({MASK_TYPE_NONE})
    @interface MaskType {
    ...
    public void setLocatorDrawable(Drawable locatorDrawable) {
        this.locatorDrawable = locatorDrawable;
    }
    ...
    public void setMaskType(@CcMaskView.MaskType int maskType) {
    ...
    public void setOrientation(@CcCameraView.Orientation int orientation) {
    }

    public CcMaskView(Context context) {
        super(context);
        init();
    }

    public CcMaskView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CcMaskView(Context context, AttributeSet attrs, int defStyleAttr) {
